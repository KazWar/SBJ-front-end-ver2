...
namespace RMS.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RMSServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("RMS", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
