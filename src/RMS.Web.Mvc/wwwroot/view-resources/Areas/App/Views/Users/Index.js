(function () {
    $(function () {
        ...
        var _dynamicParametersModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/_Bundles/manage-entity-dynamic-parameter-values-modal-min.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _dynamicParametersModal.open({ entityFullName: 'RMS.Authorization.Users.User', rowId: data.record.id});
                            }
                        }, {
