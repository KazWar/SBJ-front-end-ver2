$(function () {
    ...
    var _$Container = $('.registrations-by-campaigns');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (let i = 0; i < allTiles.length; i++) {
                    if (allTiles[i].Title == "REGISTRATIONS BY CAMPAIGN") {
                        ...
                        var dashboardContainer = document.getElementById('registrations-by-campaigns-container');
