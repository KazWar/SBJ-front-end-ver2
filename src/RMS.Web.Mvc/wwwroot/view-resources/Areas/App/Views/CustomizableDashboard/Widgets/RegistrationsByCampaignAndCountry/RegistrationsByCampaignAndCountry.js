$(function () {
    ...
    var _$Container = $('.registrations-by-campaign-and-country');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (let i = 0; i < allTiles.length; i++) {
                    if (allTiles[i].Title == "REGISTRATIONS BY CAMPAIGN AND COUNTRY") {
                        ...
                        var dashboardContainer = document.getElementById('registrations-by-campaign-and-country-container');
