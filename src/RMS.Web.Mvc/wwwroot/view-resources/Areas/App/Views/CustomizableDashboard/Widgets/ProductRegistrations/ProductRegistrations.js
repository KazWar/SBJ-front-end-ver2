$(function () {
    ...
    var _$Container = $('.product-registrations');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (let i = 0; i < allTiles.length; i++) {
                    if (allTiles[i].Title == "PRODUCT REGISTRATIONS") {
                        ...
                        var dashboardContainer = document.getElementById('product-registrations-container');
