$(function () {
    ...
    var _$Container = $('.rejected-registrations-container');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (let i = 0; i < allTiles.length; i++) {
                    if (allTiles[i].Title == "REJECTED REGISTRATIONS") {
                        ...
                        var dashboardContainer = document.getElementById('rejected-registrations-container');
