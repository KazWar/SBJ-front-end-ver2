(function () {
    $(function () {
        ...
        var _migrationsService = abp.services.app.migrations;
        ...
        $('#btn__seed-tenant').click(function (e) {
            e.preventDefault();
            console.log('Migrations App Service 1:', _migrationsService);
            console.log('Migrations App Service 2:', abp.services);

            fetch('Settings/SeedDatabase', {
                method: 'GET'
            }).then(res => console.log('result', res), error => console.error(error));

            /*_migrationsService.seedDatabase().done(function (result) {
                if (result !== false) {
                    abp.notify.success(abp.localize('SuccessfullySeededDatabase'));
                } else {
        ...
        function refreshLogo(url) {
            $('.kt-header__brand-logo-default').attr('src', url);
        }
        ...
        $('#SaveAllSettingsButton').click(function () {
            var userManagement = $.extend($('#FormBasedRegistrationSettingsForm').serializeFormToObject(), $('#OtherSettingsForm').serializeFormToObject());
