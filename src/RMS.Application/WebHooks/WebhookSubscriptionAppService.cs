...
namespace RMS.WebHooks
{
    ...
    public class WebhookSubscriptionAppService : RMSAppServiceBase, IWebhookSubscriptionAppService
    {
        ...
        public async Task<string> PublishTestWebhookAllAsync()
        {
            await _appWebhookPublisher.PublishTestWebhookAllAsync();
            return (L("WebhookSendAttemptInQueue") + "(" + L("YouHaveToSubscribeToTestWebhookToReceiveTestEvent") + ")").ToString();
        }
