...
namespace RMS.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : RMSAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<RMSDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{RMSConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{RMSConsts.ConnectionStringName}", constring);
        }
