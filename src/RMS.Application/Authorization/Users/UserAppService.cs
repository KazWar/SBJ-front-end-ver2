...
namespace RMS.Authorization.Users
{
    ...
    public class UserAppService : RMSAppServiceBase, IUserAppService
    {
        ...
        public async Task<UserEditDto> GetUserById(EntityDto<long> input)
        {
            var user = await UserManager.GetUserByIdAsync(input.Id);
            var output = ObjectMapper.Map<UserEditDto>(user);
