...
using RMS.EntityDynamicParameterValues.Dto;

namespace RMS.DynamicEntityParameters
{
    [Authorize(AppPermissions.Pages_Administration_EntityDynamicParameterValue)]
    public class EntityDynamicParameterValueAppService : RMSAppServiceBase, IEntityDynamicParameterValueAppService
    {
