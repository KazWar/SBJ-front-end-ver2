...
using RMS.Auditing.Exporting;
using RMS.Authorization;
using RMS.Authorization.Users;
using RMS.Dto;
using RMS.EntityHistory;
using EntityHistoryHelper = RMS.EntityHistory.EntityHistoryHelper;

namespace RMS.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : RMSAppServiceBase, IAuditLogAppService
    {
