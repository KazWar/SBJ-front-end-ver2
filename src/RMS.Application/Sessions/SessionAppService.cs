...
{
    public class SessionAppService : RMSAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = RMSConsts.Currency,
                    CurrencySign = RMSConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = RMSConsts.AllowTenantsToChangeEmailSettings,
