...
using RMS.EntityFrameworkCore.Repositories;

namespace RMS.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : RMSRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<RMSDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
