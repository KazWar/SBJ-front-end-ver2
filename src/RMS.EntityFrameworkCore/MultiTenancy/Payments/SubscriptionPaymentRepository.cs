...
{
    public class SubscriptionPaymentRepository : RMSRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<RMSDbContext> dbContextProvider)
