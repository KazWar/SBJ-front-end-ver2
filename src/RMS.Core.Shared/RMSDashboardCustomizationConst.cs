namespace RMS
{
    public class RMSDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string RegistrationsByStatus = "Registrations_By_Status";
                public const string ProductRegistrations = "Product_Registrations";
                public const string RejectedRegistrations = "Rejected_Registrations";
                public const string RegistrationsByCampaignAndCountry = "Registrations_By_Campaign_And_Country";
                public const string Campaigns = "Campaigns";
                public const string RegistrationsByCampaign = "Registrations_By_Campaign";
                public const string ToSendByCampaign = "To_Send_By_Campaign";
                public const string ProductRegistrationsByCampaign = "Product_Registraions_By_Campaign";
            }
